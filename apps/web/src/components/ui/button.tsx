...
const buttonVariants = cva(
  ...
  { variants: {
    variant: {
      default: 'bg-navy-950 text-white shadow-lg shadow-navy-950/15 hover:-translate-y-0.5 hover:bg-navy-800',
      accent: 'bg-amber-400 text-navy-950 shadow-lg shadow-amber-400/20 hover:-translate-y-0.5 hover:bg-amber-300',
