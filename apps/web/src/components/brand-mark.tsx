...
export function BrandMark({
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="grid size-10 place-items-center rounded-xl bg-amber-400 text-navy-950 shadow-lg shadow-amber-400/20">
      ...
      {!compact && (
        <div>
          ...
          <div
            className={cn(
              "mt-1 text-[9px] font-bold uppercase tracking-[.18em]",
